                    ...
                    <ScrollArea className="flex-grow">
                        <div className="space-y-2">
                            <div className="flex flex-col gap-1">
                                ...
                                <Link to={"/chat/123"} className="flex justify-between items-center px-2 py-1 hover:bg-gray-200 rounded-md cursor-pointer">
                                    <p className="text-base text-slate-900">Xin chào! Tôi có thể</p>
                                    <DropdownMenu>
